...
\begin{column}{0.5\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/naisb.jpg}}
\end{center}
\end{column}
\end{columns}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../../images/graf_dados.png}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/neg.jpg}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/med.jpg}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/crimes.jpg}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/cliente.png}}
\end{center}
\end{frame}
...
\begin{column}{0.5\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/dados_em_conhecimento.png}}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.5\linewidth}
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/data_mining.png}}
\end{center}
\end{column}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-important-color-frame, opacityback=0, colback=white, breakable, left=2mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm]
