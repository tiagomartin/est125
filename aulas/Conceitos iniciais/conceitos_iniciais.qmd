...
![](/images/data_every_where.png){width=70%}
:::
...
## Exemplo aplicado: previsão de churn em telecom

**Problema:** prever quais clientes têm maior chance de cancelar o serviço.

<br>

### 🔄 O mesmo processo sob diferentes metodologias
...
| **Dados** | Seleção | Sample / Explore | Entendimento dos Dados |
| **Preparação** | Pré-processamento | Modify | Preparação dos Dados |
| **Modelo** | Mineração | Model | Modelagem |
| **Avaliação** | Interpretação | Assess | Avaliação |
...
- **KDD** → foco em descoberta de conhecimento  
- **SEMMA** → foco na modelagem  
- **CRISP-DM** → foco no problema de negócio  
...
::: {.content-visible when-format="pdf"}
![](/images/problem.png){fig-align="center" width="60%"}
:::
