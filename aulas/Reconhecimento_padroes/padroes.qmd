...
- Clusterização é **não supervisionada**: não há rótulos corretos.
- Avaliar para:
  - Comparar algoritmos.
...
| Externa  | ✅ Sim          | ARI, NMI, Homogeneidade  |
| Relativa | 📂 Parcial     | Gap Statistic, Elbow, CH |
...
- Redução de dimensionalidade com
  - PCA (linear)
  - UMAP ou t-SNE (não linear)
- Colorir pontos conforme cluster.
- Identificar sobreposições e separações.
