...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/preprocess.jpeg}}
\end{center}
\end{column}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../../images/time.jpg}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/tipos.png}}
\end{center}
\end{frame}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/pre.png}}
\end{center}
\end{frame}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../../images/outlier.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../../images/outlier2.png}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/assimetrica.png}}
\end{center}
\end{frame}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{../../images/espurias.png}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{../../images/inconsistentes.png}}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=6.25in,height=\textheight,keepaspectratio]{../../images/ruido2.png}
\end{center}
\end{frame}
...
\begin{itemize}
\item
  \textbf{Identificação e remoção de valores atípicos:} valores que são
  muito diferentes dos outros valores no conjunto de dados podem ser
  identificados como valores atípicos.

  \begin{itemize}
  \tightlist
  \item
    Esses valores podem ser removidos do conjunto de dados ou tratados
    separadamente para minimizar o impacto no resultado da análise.
  \end{itemize}
\end{itemize}
...
\tightlist
\item
  \textbf{Correção de erros de entrada de dados:} erros de entrada de
  dados podem ser corrigidos por meio da revisão manual dos dados ou por
  meio de algoritmos de detecção e correção automática de erros.
\end{itemize}
\end{frame}
...
\tightlist
\item
  \textbf{Normalização ou padronização de dados:} a normalização ou a
  padronização de dados pode ser usada para tornar os dados comparáveis
  e interpretáveis, especialmente quando os dados têm unidades
...
\tightlist
\item
  \textbf{Utilização de técnicas de agrupamento:} técnicas de
  agrupamento, como análise de cluster, podem ser usadas para
  identificar padrões em um conjunto de dados e reduzir o impacto do
  ruído.
\end{itemize}
\end{frame}
...
\tightlist
\item
  \textbf{Utilização de técnicas de suavização de dados:} técnicas de
  suavização, como média móvel ou suavização exponencial, podem ser
  usadas para reduzir o impacto do ruído nos dados.
\end{itemize}

\begin{center}
\includegraphics[width=4.16667in,height=\textheight,keepaspectratio]{../../images/suavizacao.png}
\end{center}
\end{frame}

\begin{frame}{Como identificar um valor atípico?}
\phantomsection\label{como-identificar-um-valor-atuxedpico}
\begin{itemize}
\tightlist
\item
  \textbf{Gráfico box-plot}
\end{itemize}
...
\tightlist
\item
  \textbf{Z-score:} valores com um z-score maior do que um limite
  (geralmente 3) são considerados valores atípicos.
\end{itemize}
...
\tightlist
\item
  \textbf{Intervalo interquartil (IQR):} valores abaixo de Q1 - 1,5 x
  IQR ou acima de Q3 + 1,5 x IQR são considerados valores atípicos.
\end{itemize}
...
\tightlist
\item
  \textbf{Método de DBSCAN:} é um algoritmo de clusterização que agrupa
  pontos de dados que estão próximos uns dos outros e identifica valores
  que não estão próximos a nenhum cluster, o que pode ser um sinal de
  valores atípicos.
\end{itemize}
\end{frame}

\begin{frame}{Como identificar um valor atípico?}
\phantomsection\label{como-identificar-um-valor-atuxedpico-1}
Quaisquer que sejam as técnicas empregadas, a \textbf{documentação} e o
\textbf{registro das etapas de limpeza de dados} são \textbf{essenciais}
para garantir a \textbf{reprodutibilidade}, \textbf{transparência},
\textbf{colaboração}, \textbf{auditabilidade} e \textbf{controle de
qualidade em análises de dados}.
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{../../images/fig01.png}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{../../images/fig02.png}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{../../images/fig03.png}}
\end{frame}
...
\begin{column}{0.5\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-1-1.png}}
\end{column}
\end{columns}
...
\begin{column}{0.5\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-2-1.png}}
\end{column}
\end{columns}
...
\begin{column}{0.5\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-3-1.png}}
\end{column}
\end{columns}
...
\begin{column}{0.5\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-4-1.png}}
\end{column}
\end{columns}
