...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-important-color-frame, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, left=2mm, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colback=white, opacityback=0, colframe=quarto-callout-important-color-frame, left=2mm, breakable, rightrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, titlerule=0mm, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, left=2mm, breakable]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, left=2mm, breakable]
\begin{minipage}[t]{5.5mm}
...
\begin{columns}[T]
\begin{column}{0.5\linewidth}
\begin{block}{👉 \textbf{Transformação logarítmica}}
\phantomsection\label{transformauxe7uxe3o-logaruxedtmica}
\begin{itemize}
\tightlist
\item
  reduz \textbf{assimetria}
\item
  estabiliza a \textbf{variância}
\item
...
\phantomsection\label{raiz-quadrada}
\begin{itemize}
\tightlist
\item
  reduz \textbf{assimetria}
\item
  diminui a \textbf{variância}
\item
  mantém melhor a \textbf{escala original}
\end{itemize}
\end{block}
\end{column}
...
\item
  estabiliza a \textbf{variância}
\item
  melhora o ajuste de modelos
\end{itemize}
\end{block}

\begin{block}{💡 Característica}
\phantomsection\label{caracteruxedstica}
\begin{itemize}
\tightlist
\item
  transformação \textbf{paramétrica}\\
\item
  depende do parâmetro \(\lambda\)
\end{itemize}
\end{block}
\end{column}

\begin{column}{0.55\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-5-1.png}}
\end{column}
\end{columns}

⚠️ \textbf{Restrição:} Só pode ser aplicada a dados positivos
\end{frame}
...
\phantomsection\label{yeo-johnson}
\begin{itemize}
\tightlist
\item
  semelhante ao \textbf{Box-Cox}\\
\item
  reduz \textbf{assimetria}\\
\item
  estabiliza a \textbf{variância}
...
\begin{block}{💡 Diferença chave}
\phantomsection\label{diferenuxe7a-chave}
✔ funciona com \textbf{valores negativos}\\
✔ mais flexível que Box-Cox
\end{block}
\end{column}

\begin{column}{0.5\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{pre_processamento_files/figure-beamer/unnamed-chunk-6-1.png}}
\end{column}
\end{columns}

🚀 \textbf{Insight:} Yeo-Johnson = Box-Cox sem restrição de positividade
\end{frame}
...
\begin{frame}{Qual transformação usar?}
\phantomsection\label{qual-transformauxe7uxe3o-usar}
\begin{columns}[T]
\begin{column}{0.25\linewidth}
\begin{block}{🔵 log(x)}
\phantomsection\label{logx}
\textbf{Quando usar}
...
\begin{column}{0.25\linewidth}
\begin{block}{🟣 Box-Cox}
\phantomsection\label{box-cox-1}
\textbf{Quando usar}
...
\begin{column}{0.25\linewidth}
\begin{block}{🟠 Yeo-Johnson}
\phantomsection\label{yeo-johnson-1}
\textbf{Quando usar}
