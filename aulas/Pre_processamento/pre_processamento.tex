...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, colback=white, colframe=quarto-callout-important-color-frame, opacityback=0, breakable, rightrule=.15mm, leftrule=.75mm, left=2mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, coltitle=black, breakable, toptitle=1mm, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, colback=white, colframe=quarto-callout-important-color-frame, opacityback=0, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, colback=white, colframe=quarto-callout-warning-color-frame, opacityback=0, breakable, rightrule=.15mm, leftrule=.75mm, left=2mm, bottomrule=.15mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, colback=white, colframe=quarto-callout-tip-color-frame, opacityback=0, breakable, rightrule=.15mm, leftrule=.75mm, left=2mm, bottomrule=.15mm]
\begin{minipage}[t]{5.5mm}
