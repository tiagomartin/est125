...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, toprule=.15mm, leftrule=.75mm, opacityback=0, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, breakable, bottomtitle=1mm, toprule=.15mm, arc=.35mm, toptitle=1mm, rightrule=.15mm, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, toprule=.15mm, leftrule=.75mm, opacityback=0, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, left=2mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, toprule=.15mm, leftrule=.75mm, opacityback=0, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, left=2mm]
\begin{minipage}[t]{5.5mm}
