...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, colback=white, breakable, left=2mm, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toprule=.15mm, titlerule=0mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, breakable, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomrule=.15mm, arc=.35mm, left=2mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, colback=white, breakable, left=2mm, leftrule=.75mm, opacityback=0]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, breakable, left=2mm, leftrule=.75mm, opacityback=0]
\begin{minipage}[t]{5.5mm}
